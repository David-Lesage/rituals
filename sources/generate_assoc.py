...
.kick{letter-spacing:.32em;text-transform:uppercase;font-size:12px;font-weight:600;color:var(--gold);margin-bottom:14px}
...
.card .t{color:var(--gold);font-size:12px;letter-spacing:.16em;text-transform:uppercase;font-weight:600}
...
.statuts .box .art{color:var(--gold);font-size:12px;letter-spacing:.12em;text-transform:uppercase;font-weight:600}
...
<section class="statuts" id="statuts"><div class="wrap">
  ...
  <div class="box">
    ...
    <p style="color:var(--muted);font-size:14px">Statuts complets disponibles sur demande à contact@resonancesproductions.org.</p>
  </div>
</div></section>
...
<footer id="contact"><div class="wrap">
  <div class="fgrid">
    ...
    <div>
      ...
      <p>6 rue de la Condamine<br>11300 Festes-et-Saint-André</p>
